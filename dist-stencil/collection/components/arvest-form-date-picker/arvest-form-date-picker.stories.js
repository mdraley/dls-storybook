...
export default {
  ...
  argTypes: Object.assign({}, arvestFormDatePickerArgs)
};
const TemplateDatePicker = ({ name, identifier, disabled, required, min, max, role, label, placeholder, value }) => `
...
DatePicker.args = Object.assign({}, args);
