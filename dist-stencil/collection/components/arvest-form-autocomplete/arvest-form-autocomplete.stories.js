...
const Component = ({ elemId, label, options, width, scrollEnabled, disabled, name, small, placeholder, required, autocomplete, value }) => `
...
Autocomplete.args = Object.assign({}, args);
