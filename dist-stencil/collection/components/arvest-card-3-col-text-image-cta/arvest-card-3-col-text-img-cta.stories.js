...
export default {
  ...
  argTypes: Object.assign({}, card3ColTextImgCtaArgs),
  parameters: {
    layout: 'fullscreen'
  }
};
const Template3ColTextImgCta = ({ mainheadline, imageone, altone, titleone, bodyone, ctaone, linkone, imagetwo, alttwo, titletwo, bodytwo, ctatwo, linktwo, imagethree, altthree, titlethree, bodythree, ctathree, linkthree, imagefour, altfour, titlefour, bodyfour, ctafour, linkfour }) => `
...
Card3ColTextImageCTA.args = Object.assign({}, args);
