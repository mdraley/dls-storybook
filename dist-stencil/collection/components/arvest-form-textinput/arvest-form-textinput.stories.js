...
export default {
  ...
  argTypes: Object.assign({}, arvestFormTextInputArgs)
};
const TemplateTextInput = ({ elemId, type, label, ariaLabel, ariaRequired, autocomplete, required, disabled, error, value }) => `
...
TextInput.args = Object.assign({}, args);
