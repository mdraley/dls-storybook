...
export class ArvestComparisonTable {
  ...
  render() {
    return (h(Host, null,
      h("arvest-comparison-table-headers", { headers: [
          {
          ...
          },
          {
            ...
            description: 'Enjoy free checks, online BillPay and lots of extras',
            cta: 'Get Started'
          },
          {
            cardTitle: 'myBlue®',
            description: 'Affordable checking with IDProtect® and valuable benefits',
            cta: 'Get Started'
          },
          {
      ...
      h("arvest-accordion", { type: "table", activeCol: this.slidePosition, accordiontitle: "Fees", rowtitles: [
          ...
          [
            ...
            {
              variant: CellVariant.singleText,
              data: 'Ages 62+ (single wallet style, shipping and handling fees apply)'
            }
          ],
          [
            { variant: CellVariant.singleText,
      ...
      h("arvest-accordion", { type: "table", accordiontitle: "Features", rowtitles: [
          'IDProtect®†',
          'Earns interest',
          'Free debit card',
      ...
      h("arvest-accordion", { type: "table", accordiontitle: "Benefits", rowtitles: ['Additional club package benefits'], cols: [
          [
            {
              variant: CellVariant.nonBulletList,
              data: [
  ...
  static get is() { return "arvest-comparison-table"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() { return {
    "$": ["arvest-comparison-table.css"]
  }; }
