...
const ArvestCarousel = class {
  constructor(hostRef) {
    ...
    this.handleNext = () => {
      this.activeIndex < this.children.length - 1
        ? this.activeIndex += 1
        : this.activeIndex = 0;
      this.slideDirection = enums.SlideDirection.right;
    };
    this.handlePrev = () => {
      this.activeIndex > 0
        ? this.activeIndex -= 1
        : this.activeIndex = this.children.length - 1;
      this.slideDirection = enums.SlideDirection.left;
    };
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "carousel slide " }, index.h("ol", { class: "carousel-indicators" }, this.children.map((child, index$1) => index.h("li", { "data-target": child, "data-slide-to": index$1, onClick: () => this.handleGoToIndex(index$1), class: `${index$1 === this.activeIndex && 'active'}` }))), index.h("div", { class: "carousel-inner" }, this.children.map((child, index$1) => index.h("div", { class: `carousel-item ${index$1 === this.activeIndex && 'active'}`, innerHTML: child.outerHTML })), index.h("a", { onClick: this.handlePrev, class: "carousel-control-prev", href: "#", role: "button", "data-slide": "prev" }, index.h("span", { class: "carousel-control-prev-icon", "aria-hidden": "true" })), index.h("a", { onClick: this.handleNext, class: "carousel-control-next", href: "#", role: "button", "data-slide": "next" }, index.h("span", { class: "carousel-control-next-icon", "aria-hidden": "true" }))))));
  }
  get host() { return index.getElement(this); }
};
ArvestCarousel.style = arvestCarouselCss;

exports.arvest_carousel = ArvestCarousel;
