...
const ArvestToast = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: `toast fade ${this.show ? 'show' : ''}`, role: "alert", "aria-live": "assertive", "aria-atomic": "true" }, index.h("div", { class: "toast-header" }, this.imgsrc && index.h("img", { src: this.imgsrc, class: "rounded mr-2", alt: this.imgalt }), index.h("strong", { class: "mr-auto" }, "Bootstrap"), index.h("small", { class: "text-muted" }, "11 mins ago"), index.h("button", { onClick: this.handleClose, type: "button", class: "ml-2 mb-1 close", "data-dismiss": "toast", "aria-label": "Close" }, index.h("span", { "aria-hidden": "true" }, "\u00D7"))), index.h("div", { class: "toast-body" }, index.h("slot", null)))));
  }
};
ArvestToast.style = arvestToastCss;

exports.arvest_toast = ArvestToast;
